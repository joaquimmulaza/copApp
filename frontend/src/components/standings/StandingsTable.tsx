      ...
      <table className="w-full text-sm" role="table">
        <thead>
          <tr className="border-b border-border text-muted-foreground text-xs uppercase">
            <th scope="col" className="text-left p-3 w-8">#</th>
            <th scope="col" className="text-left p-3">Equipa</th>
            <th scope="col" className="text-right p-3 w-10">J</th>
            <th scope="col" className="text-right p-3 w-10">V</th>
            <th scope="col" className="text-right p-3 w-10">E</th>
            <th scope="col" className="text-right p-3 w-10">D</th>
            <th scope="col" className="text-right p-3 w-10">Pts</th>
          </tr>
        </thead>
        <tbody>
          {group.standings.map((s) => (
            <tr key={s.id} className="border-b border-border/50 last:border-0 hover:bg-surface-overlay/30 transition-colors">
              ...
              <td className="p-3 text-right font-mono font-semibold text-gold">{s.points}</td>
            </tr>
          ))}
        </tbody>
      </table>
