...
const AiPage = () => {
  ...
  if (isLoadingFixtures) {
    return (
      <div className="flex flex-col gap-6 animate-fade-in max-w-7xl mx-auto px-4 py-6">
  ...
  return (
    <div className="animate-fade-in max-w-7xl mx-auto px-4 py-4 sm:py-6 flex flex-col gap-6">
      {/* Header Area */}
